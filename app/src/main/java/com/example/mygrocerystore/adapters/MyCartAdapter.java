...
public class MyCartAdapter extends RecyclerView.Adapter<MyCartAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        MyCartModel myCartModel=cartModelList.get(position);
                        ...
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if(task.isSuccessful()){
                                    cartModelList.remove(myCartModel );
                                    notifyDataSetChanged();
                                    Toast.makeText(context, "ItemDeleted", Toast.LENGTH_SHORT).show();
                                }
                                else {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            date=itemView.findViewById(R.id.curren_date);
            time=itemView.findViewById(R.id.curren_time);
